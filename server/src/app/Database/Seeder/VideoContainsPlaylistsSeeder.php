...
/**
 * This is a seeder which fills the videoContainsPlaylists table with data for development reasons.
...
class VideoContainsPlaylistsSeeder {
 ...
 */
    ...
    public function up() {
        Schema::insert(function(Models\VideoContainsPlaylistsModel $model) {
            $videos = [
                1,
                2,
                3,
 ...
 */
    ...
    public function down() {
        Schema::truncate('videoContainsPlaylists');
    }
}
