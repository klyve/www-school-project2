...
/**
 * This is a seeder which fills the videos table with data for development reasons.
 ...
 */
    ...
    public function up() {
        Schema::insert(function(Models\VideoModel $model) {
            $videoNames = [
                'video1',
                'video2',
                'video3',
            ...
            foreach($videoNames as $videoName) {
                $model->videoId = "The identifier for the video";
                $model->name = $videoName;
                $model->description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sed facilisis mauris, vel hendrerit neque. Vivamus laoreet gravida dolor, sed laoreet sapien pharetra in. ";
                $model->userId = 1;
