...
/**
 * This is a migrator which creates the languages table and sets the fields
 ...
 */
    ...
    public function up() {
        Schema::create('languages', function($table){
            ...
            $table->string('language')->length(50);
        });
    }
