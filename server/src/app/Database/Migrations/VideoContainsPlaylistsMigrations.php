...
/**
 * This is a migrator which creates the videoContainsPlaylists table and sets the fields
...
class VideoContainsPlaylistsMigrations {
 ...
 */
    ...
    public function up() {
        Schema::create('videoContainsPlaylists', function($table){
 ...
 */
    ...
    public function down() {
        Schema::destroy('videoContainsPlaylists');
    }
