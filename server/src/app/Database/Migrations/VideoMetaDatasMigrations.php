...
/**
 * This is a migrator which creates the videoMetaDatas table and sets the fields
...
class VideoMetaDatasMigrations {
 ...
 */
    ...
    public function up() {
        Schema::create('videoMetaDatas', function($table){
