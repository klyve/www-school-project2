...
/**
 * This is a migrator which creates the lecturenotes table and sets the fields
 ...
 */
    ...
    public function up() {
        Schema::create('lecturenotes', function($table){
            $table->primary('id')->autoIncrement();
            $table->number('userId');
            $table->number('videoId');
            $table->string('note')->length(2500);
        });
    }
